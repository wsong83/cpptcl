...
void test1()
{
     ...
     }
     {
          ...
          object o2("ma"); o2.append(i, o1); // o2=="ma {malego kota}"
          object o3("Ala"); o3.append(i, o2); // o3=="Ala {ma {malego kota}}"
          object o4("list");
          object o5("set");
          ...
          s = static_cast<std::string>(
               i.eval("lindex [lindex [lindex $list 1] 1] 0"));
          assert(s == "malego");
     }
}
